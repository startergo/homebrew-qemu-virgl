...
class QemuVirgl < Formula
  ...
  bottle do
    sha256 arm64_sequoia: "d3d1d0974a361c968bf2903d49345d45ab93caaf296bad365195a98b25a8a1b4", url: "https://github.com/startergo/homebrew-qemu-virgl/releases/download/v20251125.173010/qemu-virgl--10.1.2.arm64_sequoia.bottle.tar.gz"
  end
